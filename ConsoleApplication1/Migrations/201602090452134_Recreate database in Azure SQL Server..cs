namespace ConsoleApplication1.Migrations
{
    ...
    public partial class RecreatedatabaseinAzureSQLServer : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Entry", t => t.EntryId, cascadeDelete: false)
                .ForeignKey("dbo.Header", t => t.HeaderId, cascadeDelete: true)
                .Index(t => t.HeaderId)
                .Index(t => t.EntryId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Header", t => t.HeaderId, cascadeDelete: false)
                .ForeignKey("dbo.Section", t => t.SectionId, cascadeDelete: false)
                .Index(t => t.HeaderId)
                .Index(t => t.EntryId)
                .Index(t => t.SectionId);
